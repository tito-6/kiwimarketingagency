...
export function ProjelerMarquee() {
  ...
  return (
    <div className="overflow-hidden border-y border-neutral-900/10 py-6">
      <div
      ...
      >
        {row.map((item, i) => (
          <span
            key={`${item}-${i}`}
            className="text-[clamp(1.25rem,3vw,2.5rem)] font-bold uppercase tracking-tighter text-neutral-900/[0.06]"
          >
            {item}
