...
export function ServiceHero({
  ...
  return (
    <section
      className={
        flushTop
          ? "relative overflow-hidden bg-white pb-16 pt-8 md:pb-24 md:pt-10"
          : "relative overflow-hidden bg-white pb-16 pt-28 md:pb-24 md:pt-36"
      }
    >
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1440px] px-4 sm:px-6 md:px-10">
        ...
        <h1 className="mt-6 max-w-4xl text-[clamp(2.25rem,6vw,4.5rem)] font-light leading-[1.05] tracking-tight text-neutral-900">
          {h1}
        </h1>
